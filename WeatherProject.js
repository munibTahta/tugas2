...
<Text style={[styles.largeText2, styles.textStyle, styles.black]}>Munib Tahta Hidayat</Text>
<Text style={[styles.largeText2, styles.textStyle, styles.black]}>2015150120</Text>    
      </ImageBackground>
    );
  }
}
